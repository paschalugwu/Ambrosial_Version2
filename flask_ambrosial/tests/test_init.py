#!/usr/bin/env python3
"""
Unit tests for the Flask application in the flask_ambrosial module.
"""

import unittest
from flask import Flask, session, request, render_template
from flask import template_rendered
from flask_ambrosial import create_app, db, bcrypt, login_manager
from flask_ambrosial import mail, migrate, socketio, babel
...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_setlang_route(self):
        ...
        with self.client as c:
            for lang in LANGUAGES:
                response = c.get(
                    f'/setlang?lang={lang}', follow_redirects=True
                )
    ...
    def captured_templates(self, app):
        """
        Capture the templates rendered during a request.
        """
        recorded = []
